                    ...
                    <div class="row-fluid filter-block">
                        ...
                        <div class="pull-right">
                           ...
                           function search(){
                            ...
                            <a class="btn-flat new-product" href="bg/system!goAddOrUpdateType" >+ 新 增</a>
                        </div>
                                	...
                                	<tr class="${temp }" style="height: 50px;" >
	                                    ...
	                                    <td >
	                                        <c:forEach items="${list }" var="list">
	                                        	<c:if test="${pd[0].type == list.type }">
	                                        		${list.name }
	                                        	</c:if>
	                                        </c:forEach>
	                                        <ul class="actions">
	                                            <li><i class="table-edit" onclick="location.href='bg/system!goAddOrUpdateType?type.id=${pd[0].id }'"></i></li>
	                                        ...
	                                        function del(id){
	                            				...
	                            				$('#sure').attr("href","bg/system!delType?type.id="+id+"&queryValue=${queryValue }");
	                                        }
	                                        </script>
	                                    </td>
	                                </tr>
