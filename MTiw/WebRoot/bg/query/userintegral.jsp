                            ...
                            <tbody>
                                ...
                                <c:forEach items="${pu.data }" var="pd" >
                                	...
                                	<tr class="${temp }" style="height: 50px;" >
	                                    ...
	                                    <td>
	                                    	<c:choose>
	                                    		<c:when test="${pd.platform == 1 }">推荐</c:when>
		                                    	<c:when test="${pd.platform == 2 }">万普</c:when>
		                                    	<c:when test="${pd.platform == 3 }">巨朋</c:when>
		                                    	<c:when test="${pd.platform == 4 }">点乐</c:when>
		                                    	<c:when test="${pd.platform == 5 }">多盟</c:when>
		                                    	<c:when test="${pd.platform == 6 }">磨盘</c:when>
		                                    	<c:when test="${pd.platform == 7 }">易积分</c:when>
		                                    	<c:when test="${pd.platform == 8 }">果盟</c:when>
		                                    	<c:when test="${pd.platform == 9 }">安沃</c:when>
		                                    	<c:when test="${pd.platform == 10 }">趣米</c:when>
		                                    	<c:when test="${pd.platform == 11 }">米迪</c:when>
	                                    	</c:choose>
	                                    </td>
