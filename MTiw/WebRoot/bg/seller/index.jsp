		...
		<c:if test="${ tree.id == menuId  }">${tree.name }</c:if> 	  
                    ...
                    <div class="row-fluid filter-block">
                        ...
                        <div class="pull-right">
                           ...
                           function search(){
                            ...
                            <a class="btn-flat new-product" href="bg/seller!goAddOrUpdateSeller">+ 新 增</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${pu.data }" var="pd" >
                                	...
                                	<tr class="${temp }" style="height: 50px;" >
                                        ...
                                        <span>
                                        <c:if test="${fn: length(pd.name)>11}">  
								          	${fn: substring(pd.name, 0, 12)}...
								          </c:if> 
								         <c:if test="${fn: length(pd.name)<=11}">
								          ${pd.name }
								          </c:if>
	                                    ...
	                                    <td >
	                                        ${pd.addTime }
	                                        <ul class="actions">
	                                            <li><a href="bg/seller!goAddOrUpdateSeller?seller.id=${pd.id }"><i class="table-edit" ></i></a></li>
	                                        ...
	                                        function del(id){
	                            				...
	                            				$('#sure').attr("href","bg/seller!delSeller?seller.id="+id+"&queryValue=${queryValue }");
	                                        }
	                                        </script>
	                                    </td>
	                                </tr>
			...
			<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  ...
			  <div class="modal-body">
			    <p id="tipContent">确定删除此条记录？若删除将会删除相关商品以及评论数据。</p>
			  </div>
