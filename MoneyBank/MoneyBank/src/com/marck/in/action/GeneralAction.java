	...
	*/
	public String dl(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),openudid+pack_name,null,11,map)){
	...
	*/
	public String dm(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,12,map)){
	...
	public String lm(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,13,map)){
	...
	public String qm(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,14,map)){
	...
	public String aw(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),ts+openudid,null,10,map)){
	...
	*/
	...
	public String yjf(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,9,map)){
	...
	public String xy(){
		try {
			...
			if(if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),null,null,9,map);
	...
	public String gm(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,price,2,map)){
	...
	*/
	public String ck(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,6,map)){
	...
	public String dr(){
		try {
			...
			if(generalService.addIntergral(userId,openudid,points,adname,DateUtil.getNowString("yyyy-MM-dd HH:mm:ss"),orderId,null,8,map)){
